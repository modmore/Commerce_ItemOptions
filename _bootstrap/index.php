...
if (!createObject('modNamespace',array(
    'name' => 'commerce_itemoptions',
    'path' => $componentPath.'/core/components/commerce_itemoptions/',
    'assets_path' => $componentPath.'/assets/components/commerce_itemoptions/',
),'name', false)) {
    echo "Error creating namespace commerce_itemoptions.\n";
}

/* Path settings */
if (!createObject('modSystemSetting', array(
    'key' => 'commerce_itemoptions.core_path',
    'value' => $componentPath.'/core/components/commerce_itemoptions/',
    'xtype' => 'textfield',
    'namespace' => 'commerce_itemoptions',
    'area' => 'Paths',
    'editedon' => time(),
), 'key', false)) {
    echo "Error creating commerce_itemoptions.core_path setting.\n";
}

if (!createObject('modSystemSetting', array(
    'key' => 'commerce_itemoptions.assets_path',
    'value' => $componentPath.'/assets/components/commerce_itemoptions/',
    'xtype' => 'textfield',
    'namespace' => 'commerce_itemoptions',
    'area' => 'Paths',
    'editedon' => time(),
), 'key', false)) {
    echo "Error creating commerce_itemoptions.assets_path setting.\n";
}
...
$assetsUrl = "{$requestUri}assets/components/commerce_itemoptions/";

if (!createObject('modSystemSetting', array(
    'key' => 'commerce_itemoptions.assets_url',
    'value' => $assetsUrl,
    'xtype' => 'textfield',
    'namespace' => 'commerce_itemoptions',
    'area' => 'Paths',
    ...
    echo "Error creating commerce_itemoptions.assets_url setting.\n";
}
...
foreach ($settings as $key => $opts) {
    ...
    if (!createObject('modSystemSetting', array(
        ...
        echo "Error creating commerce_itemoptions.".$key." setting.\n";
    }
}
...
include $componentPath . '/core/components/commerce_itemoptions/vendor/autoload.php';

// Grab the path to our namespaced files
$modulePath = $componentPath . '/core/components/commerce_itemoptions/src/Modules/';

// Instruct Commerce to load modules from our directory, providing the base namespace and module path twice
$commerce->loadModulesFromDirectory($modulePath, 'modmore\\Commerce_ItemOptions\\Modules\\', $modulePath);
